...
namespace irr
{
	...
	namespace video
	{
		...
		public:
			...
			virtual ITexture* getTexture(const core::array<io::path>& files, E_TEXTURE_TYPE Type);
			...
			//! set or reset Stream output Buffer
		...
		protected:
			...
			//! THIS METHOD HAS TO BE OVERRIDDEN BY DERIVED DRIVERS WITH OWN TEXTURES
			virtual video::ITexture* createDeviceDependentTexture(const core::array<ITexture*>& surfaces, const E_TEXTURE_TYPE Type, const io::path& name, void* mipmapData = 0);
