...
namespace irr
{
	namespace scene
	{
		...
		public:
			...
			//! constructor
			CTextSceneNode(std::shared_ptr<ISceneManager > mgr, s32 id,
		...
		private:
			...
			video::SColor Color;
			gui::IGUIFont* Font;
			std::weak_ptr< scene::ISceneCollisionManager> Coll;
		...
		public:
			...
			CBillboardTextSceneNode(std::shared_ptr<ISceneManager > mgr, s32 id,
