	...
	namespace scene
	{
		...
		*/
		...
		public:
			...
			virtual std::shared_ptr<IVolumeLightSceneNode> addVolumeLightSceneNode(
				std::shared_ptr<ISceneNode> parent = 0, s32 id = -1,
			...
			//! the returned pointer must not be dropped.
			virtual std::shared_ptr<IMeshSceneNode> addCubeSceneNode(f32 size = 10.0f, std::shared_ptr<ISceneNode> parent = 0, s32 id = -1,
				const core::vector3df& position = core::vector3df(0, 0, 0),
				const core::vector3df& rotation = core::vector3df(0, 0, 0),
				const core::vector3df& scale = core::vector3df(1.0f, 1.0f, 1.0f)) _IRR_OVERRIDE_;

			//! Adds a sphere scene node to the scene.
			virtual std::shared_ptr<IMeshSceneNode> addSphereSceneNode(f32 radius = 5.0f, s32 polyCount = 16, std::shared_ptr<ISceneNode> parent = 0, s32 id = -1,
				const core::vector3df& position = core::vector3df(0, 0, 0),
				const core::vector3df& rotation = core::vector3df(0, 0, 0),
				const core::vector3df& scale = core::vector3df(1.0f, 1.0f, 1.0f)) _IRR_OVERRIDE_;

			//! adds a scene node for rendering an animated mesh model
			virtual std::shared_ptr<IAnimatedMeshSceneNode> addAnimatedMeshSceneNode(IAnimatedMesh* mesh, std::shared_ptr<ISceneNode> parent = 0, s32 id = -1,
				const core::vector3df& position = core::vector3df(0, 0, 0),
				const core::vector3df& rotation = core::vector3df(0, 0, 0),
			...
			virtual std::shared_ptr<IInstancedMeshSceneNode> addInstancedMeshSceneNode(IMesh* mesh, std::shared_ptr<ISceneNode> parent = 0, s32 id = -1,
				const core::vector3df& position = core::vector3df(0, 0, 0),
				const core::vector3df& rotation = core::vector3df(0, 0, 0),
				const core::vector3df& scale = core::vector3df(1.0f, 1.0f, 1.0f),
			...
			//! the returned pointer must not be dropped.
			virtual std::shared_ptr<IMeshSceneNode> addMeshSceneNode(IMesh* mesh, std::shared_ptr<ISceneNode> parent = 0, s32 id = -1,
				const core::vector3df& position = core::vector3df(0, 0, 0),
				const core::vector3df& rotation = core::vector3df(0, 0, 0),
				const core::vector3df& scale = core::vector3df(1.0f, 1.0f, 1.0f),
				bool alsoAddIfMeshPointerZero = false)
			...
			virtual std::shared_ptr<ISceneNode> addWaterSurfaceSceneNode(IMesh* mesh, f32 waveHeight, f32 waveSpeed, f32 wlenght, std::shared_ptr<ISceneNode> parent = 0, s32 id = -1,
				const core::vector3df& position = core::vector3df(0, 0, 0),
				const core::vector3df& rotation = core::vector3df(0, 0, 0),
				const core::vector3df& scale = core::vector3df(1.0f, 1.0f, 1.0f)) _IRR_OVERRIDE_;
			...
			virtual std::shared_ptr<ICameraSceneNode> addCameraSceneNode(std::shared_ptr<ISceneNode> parent = 0,
			...
			//! The returned pointer must not be dropped.
			virtual std::shared_ptr<ICameraSceneNode> addCameraSceneNodeMaya(std::shared_ptr<ISceneNode> parent = 0,
				f32 rotateSpeed = -1500.f,
				f32 zoomSpeed = 200.f,
				f32 translationSpeed = 1500.f, s32 id = -1,
				f32 distance = 70.f,
				bool makeActive = true) _IRR_OVERRIDE_;

			//! Adds a camera scene node which is able to be controled with the mouse and keys
			//! like in most first person shooters (FPS):
			virtual std::shared_ptr<ICameraSceneNode> addCameraSceneNodeFPS(std::shared_ptr<ISceneNode> parent = 0,
				f32 rotateSpeed = 100.0f,
				f32 moveSpeed = .5f, s32 id = -1,
			...
			virtual std::shared_ptr<ILightSceneNode> addLightSceneNode(std::shared_ptr<ISceneNode> parent = 0,
				const core::vector3df& position =
				core::vector3df(0, 0, 0),
				video::SColorf color = video::SColorf(
					1.0f, 1.0f, 1.0f),
			...
			virtual std::shared_ptr<IBillboardSceneNode> addBillboardSceneNode(std::shared_ptr<ISceneNode> parent = 0,
				const core::dimension2d<f32>& size =
				core::dimension2d<f32>(10.0f, 10.0f),
				const core::vector3df& position =
				core::vector3df(0, 0, 0),
				s32 id = -1,
				video::SColor shadeTop = 0xFFFFFFFF,
				video::SColor shadeBottom = 0xFFFFFFFF)
				_IRR_OVERRIDE_;

			//! Adds a skybox scene node. A skybox is a big cube with 6 textures on it and
			//! is drawn around the camera position.
			virtual std::shared_ptr<ISceneNode> addSkyBoxSceneNode(video::ITexture* top, video::ITexture* bottom,
				video::ITexture* left, video::ITexture* right, video::ITexture* front,
				video::ITexture* back, std::shared_ptr<ISceneNode> parent = 0, s32 id = -1) _IRR_OVERRIDE_;

			//! Adds a skydome scene node. A skydome is a large (half-) sphere with a
			//! panoramic texture on it and is drawn around the camera position.
			virtual std::shared_ptr<ISceneNode> addSkyDomeSceneNode(video::ITexture* texture,
				u32 horiRes = 16, u32 vertRes = 8,
				f32 texturePercentage = 0.9, f32 spherePercentage = 2.0, f32 radius = 1000.f,
				std::shared_ptr<ISceneNode> parent = 0, s32 id = -1) _IRR_OVERRIDE_;

			//! Adds a text scene node, which is able to display
			//! 2d text at a position in three dimensional space
			virtual std::shared_ptr<ITextSceneNode> addTextSceneNode(gui::IGUIFont* font, const wchar_t* text,
				video::SColor color =
				video::SColor(100, 255, 255, 255),
				std::shared_ptr<ISceneNode> parent = 0,
				const core::vector3df& position = core::vector3df(
					0, 0, 0),
				s32 id = -1) _IRR_OVERRIDE_;

			//! Adds a text scene node, which uses billboards
			virtual std::shared_ptr<IBillboardTextSceneNode> addBillboardTextSceneNode(
			...
			virtual std::shared_ptr<IMeshSceneNode> addQuake3SceneNode(const IMeshBuffer* meshBuffer,
			...
			virtual std::shared_ptr<IParticleSystemSceneNode> addParticleSystemSceneNode(
				bool withDefaultEmitter = true, std::shared_ptr<ISceneNode> parent = 0, s32 id = -1,
				const core::vector3df& position = core::vector3df(0, 0, 0),
				const core::vector3df& rotation = core::vector3df(0, 0, 0),
				const core::vector3df& scale = core::vector3df(1.0f, 1.0f, 1.0f)) _IRR_OVERRIDE_;

			//! Adds a terrain scene node to the scene graph.
			virtual std::shared_ptr<ITerrainSceneNode> addTerrainSceneNode(
			...
			virtual std::shared_ptr<IDummyTransformationSceneNode> addDummyTransformationSceneNode(
				std::shared_ptr<ISceneNode> parent = 0, s32 id = -1) _IRR_OVERRIDE_;

			//! Adds an empty scene node.
			virtual std::shared_ptr<ISceneNode> addEmptySceneNode(std::shared_ptr<ISceneNode> parent, s32 id = -1)
				_IRR_OVERRIDE_;
			...
			virtual std::shared_ptr<ISceneNode> getRootSceneNode() _IRR_OVERRIDE_;
			...
			*/
			...
			virtual ISceneNodeAnimatorCollisionResponse* createCollisionResponseAnimator(
				ITriangleSelector* world,std::shared_ptr<ISceneNode> sceneNode,
			...
			virtual ITriangleSelector* createTriangleSelector(IMesh* mesh, std::shared_ptr<ISceneNode> node) _IRR_OVERRIDE_;
			...
			virtual ITriangleSelector* createTriangleSelector(std::shared_ptr<IAnimatedMeshSceneNode> node) _IRR_OVERRIDE_;

			//! Creates a simple ITriangleSelector, based on a mesh.
			virtual ITriangleSelector* createOctreeTriangleSelector(IMesh* mesh,
				std::shared_ptr<ISceneNode> node, s32 minimalPolysPerNode) _IRR_OVERRIDE_;

			//! Creates a simple dynamic ITriangleSelector, based on a axis aligned bounding box.
			virtual ITriangleSelector* createTriangleSelectorFromBoundingBox(
				std::shared_ptr<ISceneNode > node) _IRR_OVERRIDE_;
			...
			virtual ITriangleSelector* createTerrainTriangleSelector(
				std::shared_ptr<ITerrainSceneNode> node, s32 LOD = 0) _IRR_OVERRIDE_;
			...
			virtual std::shared_ptr<ISceneCollisionManager> getSceneCollisionManager() _IRR_OVERRIDE_;
			...
			virtual void addToDeletionQueue(std::shared_ptr<ISceneNode> node) _IRR_OVERRIDE_;

			//! Returns the first scene node with the specified id.
			virtual std::shared_ptr<ISceneNode> getSceneNodeFromId(s32 id, std::shared_ptr<ISceneNode> start = 0) _IRR_OVERRIDE_;

			//! Returns the first scene node with the specified name.
			virtual std::shared_ptr<ISceneNode> getSceneNodeFromName(const c8* name, std::shared_ptr<ISceneNode> start = 0)
				_IRR_OVERRIDE_;

			//! Returns the first scene node with the specified type.
			virtual std::shared_ptr<ISceneNode> getSceneNodeFromType(scene::ESCENE_NODE_TYPE type, std::shared_ptr<ISceneNode> start = 0) _IRR_OVERRIDE_;

			//! returns scene nodes by type.
			virtual void getSceneNodesFromType(ESCENE_NODE_TYPE type, core::array < std::shared_ptr<scene::ISceneNode>>& outNodes, std::shared_ptr<ISceneNode> start = 0) _IRR_OVERRIDE_;
			...
			virtual std::shared_ptr<ISceneManager> createNewSceneManager(bool cloneContent, bool autoreg = true) _IRR_OVERRIDE_;
			...
			virtual std::shared_ptr<ISceneNode> addSceneNode(const char* sceneNodeTypeName,std::shared_ptr<ISceneNode> parent = 0) _IRR_OVERRIDE_;

			//! creates a scene node animator based on its type name
			virtual ISceneNodeAnimator* createSceneNodeAnimator(const char* typeName,std::shared_ptr<ISceneNode> target = 0) _IRR_OVERRIDE_;
			...
			virtual bool saveScene(const io::path& filename, ISceneUserDataSerializer* userDataSerializer = 0, std::shared_ptr<ISceneNode> node = 0) _IRR_OVERRIDE_;

			//! Saves the current scene into a file.
			virtual bool saveScene(io::IWriteFile* file, ISceneUserDataSerializer* userDataSerializer = 0, std::shared_ptr<ISceneNode> node = 0) _IRR_OVERRIDE_;

			//! Saves the current scene into a file.
			virtual bool saveScene(io::IXMLWriter* writer, const io::path& currentPath, ISceneUserDataSerializer* userDataSerializer = 0, std::shared_ptr<
			                       ISceneNode> node = 0) _IRR_OVERRIDE_;

			//! Loads a scene. Note that the current scene is not cleared before.
			virtual bool loadScene(const io::path& filename, ISceneUserDataSerializer* userDataSerializer = 0, std::shared_ptr<ISceneNode> rootNode = 0) _IRR_OVERRIDE_;

			//! Loads a scene. Note that the current scene is not cleared before.
			virtual bool loadScene(io::IReadFile* file, ISceneUserDataSerializer* userDataSerializer = 0, std::shared_ptr<ISceneNode> rootNode = 0) _IRR_OVERRIDE_;
			...
			virtual bool isCulled(const std::shared_ptr<ISceneNode> node) const _IRR_OVERRIDE_;
		...
		private:
			...
			//! writes a scene node
			void writeSceneNode(io::IXMLWriter* writer, std::shared_ptr<ISceneNode> node, ISceneUserDataSerializer* userDataSerializer, const fschar_t* currentPath = 0, bool init = false);

			struct DefaultNodeEntry
			{
				DefaultNodeEntry(std::shared_ptr<ISceneNode> n) :
			...
			{
				TransparentNodeEntry(std::shared_ptr<ISceneNode> n, const core::vector3df& camera)
					: Node(n)
				{
			...
			{
				DistanceNodeEntry(std::shared_ptr<ISceneNode> n, const core::vector3df& cameraPos)
					: Node(n)
				{
				...
				void setNodeAndDistanceFromPosition(std::shared_ptr<ISceneNode> n, const core::vector3df& fromPosition)
				{
					Node = n;
			...
			//! collision manager
			std::shared_ptr<ISceneCollisionManager> CollisionManager;
