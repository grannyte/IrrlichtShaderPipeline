...
void irr::scene::CSceneNodeAnimatorRotation::animateNode(ISceneNode* node, u32 timeMs)
{
...
ISceneNodeAnimator* CSceneNodeAnimatorRotation::createClone(std::shared_ptr<ISceneNode> node,
