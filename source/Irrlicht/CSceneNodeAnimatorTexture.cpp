...
void irr::scene::CSceneNodeAnimatorTexture::animateNode(ISceneNode* node, u32 timeMs)
{
	if(!node)
		return;
...
ISceneNodeAnimator* CSceneNodeAnimatorTexture::createClone(std::shared_ptr<ISceneNode> node,
