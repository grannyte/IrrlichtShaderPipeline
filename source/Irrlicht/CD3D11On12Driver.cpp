#include "CD3D11On12Driver.h"

irr::video::CD3D11On12Driver::CD3D11On12Driver(const irr::SIrrlichtCreationParameters& params, io::IFileSystem* io, HWND window)
	: CD3D11Driver(params, io, window),
	DeviceADV(NULL),
	Output(NULL)
{
#ifdef _DEBUG
	setDebugName("CD3D11On12Driver");
#endif
}

bool irr::video::CD3D11On12Driver::initDriver(HWND hwnd, bool pureSoftware)
{
...
irr::video::CD3D11On12Driver::~CD3D11On12Driver()
{
