...
namespace video
{
	...
	public:
		...
		virtual void setInstanceDataStepRate(E_INSTANCE_DATA_STEP_RATE rate, u32 bufferID, u32 IRate);
	...
	protected:
		...
		core::array<E_INSTANCE_DATA_STEP_RATE> EInstanceDataStepRate;
		core::array<irr::u32> InstanceDataStepRate;
