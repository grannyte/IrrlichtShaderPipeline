	...
	namespace video
	{
		...
		public:
			...
			virtual s32 addHighLevelShaderMaterial(
				...
				s32 userData = 0, E_GPU_SHADING_LANGUAGE shadingLang = EGSL_DEFAULT) = 0;
				...
				E_GPU_SHADING_LANGUAGE shadingLang = EGSL_DEFAULT)
			{
				return addHighLevelShaderMaterial(
					...
					callback, baseMaterial, NULL, userData, shadingLang);
			}
			...
			*/
				...
				s32 userData = 0)
			{
				return addHighLevelShaderMaterial(
					...
					0, "main", EGST_GS_4_0,
					scene::EPT_TRIANGLES, scene::EPT_TRIANGLE_STRIP, 0,
					callback, baseMaterial, NULL, userData);
			}
			...
			*/
			...
			//! Now with hull and domain Shader
			virtual s32 addHighLevelShaderMaterialFromFiles(
			...
			*/
			...
			{
				return addHighLevelShaderMaterialFromFiles(
					vertexShaderProgramFileName, "main", EVST_VS_1_1,
					pixelShaderProgramFileName, "main", EPST_PS_1_1,
					"", "main", EGST_GS_4_0,
					scene::EPT_TRIANGLES, scene::EPT_TRIANGLE_STRIP, 0,
					callback, baseMaterial, NULL, userData);
			}
			...
			*/
				...
				s32 userData = 0)
			{
				return addHighLevelShaderMaterialFromFiles(
					...
					inType, outType, verticesOut,
					callback, baseMaterial, vertexTypeOut, userData);
			}
