	...
	namespace scene
	{
		...
		*/
		...
		public:
			...
			pointer should not be dropped. See IReferenceCounted::drop()
			for more information. */
			virtual std::shared_ptr<IMeshSceneNode> addSphereSceneNode(f32 radius = 5.0f, s32 polyCount = 16,
				std::shared_ptr<ISceneNode> parent = 0, s32 id = -1,
				const core::vector3df& position = core::vector3df(0, 0, 0),
				const core::vector3df& rotation = core::vector3df(0, 0, 0),
				const core::vector3df& scale = core::vector3df(1.0f, 1.0f, 1.0f)) = 0;
			...
			This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
			virtual std::shared_ptr<IAnimatedMeshSceneNode> addAnimatedMeshSceneNode(IAnimatedMesh* mesh,
				std::shared_ptr<ISceneNode> parent = 0, s32 id = -1,
				const core::vector3df& position = core::vector3df(0, 0, 0),
				const core::vector3df& rotation = core::vector3df(0, 0, 0),
			...
			\return Pointer to the created scene node.
			This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
			virtual std::shared_ptr<ISceneNode> addWaterSurfaceSceneNode(IMesh* mesh,
			...
			This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
			template <class T>
			IMeshSceneNode* addOctreeSceneNode(IAnimatedMesh* mesh,std::shared_ptr<ISceneNode> parent = 0,
			...
			This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
			template <class T>
			std::shared_ptr<IMeshSceneNode> addOctreeSceneNode(IMesh* mesh, std::shared_ptr<ISceneNode> parent = 0,
			...
			virtual std::shared_ptr<ISceneNode> addSkyBoxSceneNode(video::ITexture* top, video::ITexture* bottom,
				...
				video::ITexture* back, std::shared_ptr<ISceneNode> parent = 0, s32 id = -1) = 0;
			...
			virtual std::shared_ptr<ISceneNode> addSkyDomeSceneNode(video::ITexture* texture,
				...
				std::shared_ptr<ISceneNode> parent = 0, s32 id = -1) = 0;
			...
			\return Pointer to the created scene node.
			This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
			virtual std::shared_ptr<ISceneNode> addEmptySceneNode(std::shared_ptr<ISceneNode> parent = 0, s32 id = -1) =
				0;
			...
			virtual IAnimatedMesh* addHillPlaneMesh(const io::path& name,
				...
				core::dimension2d<f32>(1.0f, 1.0f)) = 0;
			...
			*/
			...
			This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
			virtual std::shared_ptr<ISceneNode> getRootSceneNode() = 0;
			...
			This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
			virtual std::shared_ptr<ISceneNode> getSceneNodeFromId(s32 id, std::shared_ptr<ISceneNode> start = 0) = 0;
			...
			and null if no scene node could be found.
			This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
			virtual std::shared_ptr<ISceneNode> getSceneNodeFromName(const c8* name, std::shared_ptr<ISceneNode> start = 0) = 0;
			...
			and null if no scene node could be found.
			This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
			virtual std::shared_ptr<ISceneNode> getSceneNodeFromType(scene::ESCENE_NODE_TYPE type, std::shared_ptr<ISceneNode> start = 0) = 0;
			...
			virtual void getSceneNodesFromType(ESCENE_NODE_TYPE type,
				core::array < std::shared_ptr<scene::ISceneNode>>& outNodes,
				std::shared_ptr<ISceneNode> start = 0) = 0;
			...
			See IReferenceCounted::drop() for more information. */
			virtual ITriangleSelector* createTriangleSelector(IMesh* mesh, std::shared_ptr<ISceneNode> node) = 0;
			...
			*/
			virtual ITriangleSelector* createTriangleSelector(std::shared_ptr<IAnimatedMeshSceneNode> node) = 0;
			...
			If you no longer need the selector, you should call ITriangleSelector::drop().
			See IReferenceCounted::drop() for more information. */
			virtual ITriangleSelector* createTriangleSelectorFromBoundingBox(std::shared_ptr<ISceneNode> node) = 0;
			...
			virtual ITriangleSelector* createOctreeTriangleSelector(IMesh* mesh,
			                                                        std::shared_ptr<ISceneNode> node, s32 minimalPolysPerNode = 32) = 0;
			...
			_IRR_DEPRECATED_ ITriangleSelector* createOctTreeTriangleSelector(IMesh* mesh,
				std::shared_ptr<ISceneNode> node, s32 minimalPolysPerNode = 32)
			{
			...
			virtual ITriangleSelector* createTerrainTriangleSelector(
				std::shared_ptr<ITerrainSceneNode> node, s32 LOD = 0) = 0;
			...
			This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
			virtual std::shared_ptr<ISceneCollisionManager> getSceneCollisionManager() = 0;
			...
			virtual void addToDeletionQueue(std::shared_ptr<ISceneNode> node) = 0;
			...
			This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
			virtual std::shared_ptr<ISceneNode> addSceneNode(const char* sceneNodeTypeName,std::shared_ptr<ISceneNode> parent = 0) = 0;
			...
			virtual ISceneNodeAnimator* createSceneNodeAnimator(const char* typeName,std::shared_ptr<ISceneNode> target = 0) = 0;
			...
			ISceneManager::drop().
			See IReferenceCounted::drop() for more information. */
			virtual std::shared_ptr<ISceneManager> createNewSceneManager(bool cloneContent = false, bool autoreg = true) = 0;
			...
			virtual bool saveScene(const io::path& filename, ISceneUserDataSerializer* userDataSerializer = 0, std::shared_ptr<ISceneNode> node = 0) = 0;
			...
			is also the default).
			\return True if successful. */
			virtual bool saveScene(io::IWriteFile* file, ISceneUserDataSerializer* userDataSerializer = 0, std::shared_ptr<ISceneNode> node = 0) = 0;
			...
			\return True if successful. */
			virtual bool loadScene(const io::path& filename, ISceneUserDataSerializer* userDataSerializer = 0, std::shared_ptr<ISceneNode> rootNode = 0) = 0;
			...
			(which is also the default).
			\return True if successful. */
			virtual bool loadScene(io::IReadFile* file, ISceneUserDataSerializer* userDataSerializer = 0, std::shared_ptr<ISceneNode> rootNode = 0) = 0;
			...
			false. */
			virtual bool isCulled(const std::shared_ptr<ISceneNode> node) const = 0;
