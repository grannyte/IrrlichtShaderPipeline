		...
		*/
		...
		public:
			...
			*/
			...
			virtual void removeOcclusionQuery(std::shared_ptr<irr::scene::ISceneNode> node) = 0;
			...
			virtual void runOcclusionQuery(std::shared_ptr<irr::scene::ISceneNode> node, bool visible = false) = 0;
			...
			virtual void updateOcclusionQuery(std::shared_ptr<irr::scene::ISceneNode> node, bool block = true) = 0;
