...
namespace irr
{
	namespace scene
	{
		...
		public:
			...
			until OnPostRender().
			*/
			virtual void OnPreRender(core::array < std::shared_ptr<ISceneNode>>& lightList) = 0;
			...
			virtual void OnNodePreRender(std::shared_ptr<ISceneNode> node) = 0;
			...
			virtual void OnNodePostRender(std::shared_ptr<ISceneNode > node) = 0;
		};
	} // end namespace scene
} // end namespace irr
