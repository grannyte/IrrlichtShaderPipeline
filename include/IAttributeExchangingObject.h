...
namespace irr
{
	...
	namespace io
	{
		...
		class IIAttributeExchangingObject
		{
		public:
			virtual ~IIAttributeExchangingObject() = default;
		...
		class IAttributeExchangingObject :public IIAttributeExchangingObject, virtual public IReferenceCounted
		{
		};

		class SIAttributeExchangingObject :public IIAttributeExchangingObject, public std::enable_shared_from_this<SIAttributeExchangingObject>
		{
