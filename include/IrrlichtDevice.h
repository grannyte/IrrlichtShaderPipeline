	...
	*/
	...
	public:
		...
		*/
		...
		virtual std::shared_ptr<scene::ISceneManager> getSceneManager() = 0;
		...
		virtual void setInputReceivingSceneManager(std::shared_ptr<scene::ISceneManager> sceneManager) = 0;
