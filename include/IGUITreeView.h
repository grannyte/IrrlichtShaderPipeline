	...
	namespace gui
	{
		...
		*/
		...
		public:
			...
			//! returns the user data s64 of this node
			virtual s64 getData3() const = 0;

			//! sets the user data s64 of this node
			virtual void setData3(s64 data) = 0;
			...
			*/
			virtual IGUITreeViewNode* addChildBack(
				...
				void* data = 0, IReferenceCounted* data2 = 0, irr::u64 data3 = 0) = 0;
